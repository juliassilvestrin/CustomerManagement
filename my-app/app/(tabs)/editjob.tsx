...
export default function EditJob() {
  ...
  const [customerId, setCustomerId] = useState(params.jobCustomerId || '');
  const [customerName, setCustomerName] = useState(params.jobCustomerName || '');
  const [status, setStatus] = useState(params.jobStatus || 'scheduled');
  const [priority, setPriority] = useState(params.jobPriority || 'medium');
  const [scheduledDate, setScheduledDate] = useState(new Date(params.jobScheduledDate || new Date()));
    ...
    if (success) {
      router.push({
        ...
        params: {
          ...
          jobCustomerName: updatedJob.customerName,
          jobCustomerId: updatedJob.customerId,
          jobStatus: updatedJob.status,
          jobPriority: updatedJob.priority,
          jobScheduledDate: updatedJob.scheduledDate,
          jobDueDate: updatedJob.dueDate,
          jobLocationAddress: updatedJob.location.address,
